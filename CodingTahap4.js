...
const bird = {
	...
	draw : function(){
		if(rageMode == true){
			let bird = rageAnim.animation[this.frame];

			ctx.save();
			ctx.translate(this.x , this.y);
			ctx.rotate(this.rotation);
			ctx.drawImage(sprite,bird.sX,bird.sY,rageAnim.w,rageAnim.h,- rageAnim.w/2,- rageAnim.h/2,rageAnim.w,rageAnim.h );
